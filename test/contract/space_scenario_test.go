...
func TestThreeNodeAuthorityScenario(t *testing.T) {
	...
	must(space.Command{Type: space.CommandPairNode, SpaceID: "s", HostID: "host", Epoch: 1, ActorID: "owner", NodeID: "mac", RequestID: "pair"}, space.OutcomeApplied)
	must(space.Command{Type: space.CommandAdvertiseCapability, SpaceID: "s", HostID: "host", Epoch: 1, ActorID: "mac", NodeID: "mac", CapabilityID: "agent.run/execute", Action: "run", RequestID: "advertise"}, space.OutcomeApplied)
	must(space.Command{Type: space.CommandSetGrant, SpaceID: "s", HostID: "host", Epoch: 1, ActorID: "owner", NodeID: "mac", CapabilityID: "agent.run/execute", Action: "run", Grant: space.GrantAsk, RequestID: "grant"}, space.OutcomeApplied)
	...
	must(space.Command{Type: space.CommandApprove, SpaceID: "s", HostID: "host", Epoch: 1, ActorID: "owner", TargetNodeID: "mac", ActionFingerprint: "digest", TaskID: "task", ApprovalID: "approval", ApprovedAt: 1, ExpiresAt: 2, ObservedAt: 1, RequestID: "approve"}, space.OutcomeQueued)
