...
func LoadManifest(r io.Reader) (Manifest, error) {
	...
	if m.SchemaVersion != ManifestSchemaVersion || len(m.Artifacts) == 0 {
...
func (a Artifact) validate() error {
	if (a.Name != "lumen" && a.Name != "hermes") || !semver.MatchString(a.Version) || a.ContractVersion != 1 || a.Size <= 0 || a.Size > MaxArtifactSize || !validDigest(a.SHA256) {
