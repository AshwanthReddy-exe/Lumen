# Superseded Android Host lifecycle implementation plan

> Superseded by [Host-first rearchitecture design](../specs/2026-09-07-host-first-rearchitecture-design.md). The implemented lifecycle remains historical evidence; do not extend it.
